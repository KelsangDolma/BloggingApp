...
public class RoleServiceImpl implements RoleService {
	...
	private void initializeAdminUser() {
	    if (!userRepo.findByEmail("kelsangdolmasherpa@gmail.com").isPresent()) {
	        User adminUser = createNewAdminUser("admin", "kelsangdolmasherpa@gmail.com");
	...
	private void sendOtp(User user) throws Exception {
	    ...
	    emailSender.sendMail(user.getEmail(), "OTP", "Your OTP is " + otp);
	    user.setOtp(otp);
	}
